...
public class CompanyInfoController {
	...
	private Logger log = LoggerFactory.getLogger(CompanyInfoController.class);
	...
	public @ResponseBody ResponseEntity<CompanyInfoResponse> getCompanyDetails(
			@Parameter(description = "Company code", example = "Code1") 
			@PathVariable String companyCode) {
		log.debug("Inside getCompanyDetails() of CompanyInfoController");
	...
	public @ResponseBody ResponseEntity<List<CompanyInfoResponse>> getallCompanyDetails() {
		log.debug("Inside getallCompanyDetails() of CompanyInfoController");
